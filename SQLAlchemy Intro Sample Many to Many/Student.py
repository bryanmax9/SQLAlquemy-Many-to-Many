...
class Student(Base):
    ...
    def add_section(self, section):
        ...
        # Create the new instance of StudentMajor to connect this Student to the supplied Major.
        student_section = Enrollment(self, section)  # How does this gets commited?

        # section.enrollments.append(student_section)  # Add this Student to the supplied Section.
        # self.enrollments.append(student_section)  # Add the supplied Section to this student.
